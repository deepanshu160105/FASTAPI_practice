...
products = [
    Product(id=1, name="a", description="hi", price=339.99, quantity=54),
    Product(id=2, name="b", description="bi", price=6439.99, quantity=24),
    Product(id=3, name="c", description="hii", price=63.9, quantity=86),
    Product(id=4, name="d", description="bii", price=52.99, quantity=75),
]
